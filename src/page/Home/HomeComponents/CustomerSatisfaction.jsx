...
import bgMix from '../../../../public/assets/bg-mix-up.png'
export default function CustomerSatisfaction() {
    return (
        <div className='bg-[#03373d] max-w-5xl rounded-2xl
         mx-auto text-white p-10 flex flex-col-reverse md:flex-row gap-5 relative'>
            ...
            <img src={bgMix} alt="" className='absolute -top-50 left-30 overflow-hidden' />
